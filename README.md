# NZXT Z63 Nier Automata Web Integration V2 forked by BakaVaca
...
## Quickstart
Paste the following url in NZXT CAM: 

## Note
This is version 2. I plan to create more versions, but please note that earlier versions will not be maintained. I will only keep up with the versions I actively use.

Future plans for upcoming versions include: removing the Japanese text and replacing it with the YoRHa logo, and adding an additional 'chip' or modifying current ones, as I like different metrics depending on what my needs are.
